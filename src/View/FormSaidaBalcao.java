 ...
 * @author Ussimane
 */
public class FormSaidaBalcao extends javax.swing.JDialog {
    ...
    public FormSaidaBalcao(java.awt.Frame parent, Produto p, Saida s, String t, int c, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            qtde.setText("Quantidade: " + qtdi);//ea.getQs())));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (cbe.getSelectedItem() == null) {
            lbValidacao.setVisible(true);
            lbValidacao.setText("Seleccione a Serie");
...
//            }
            ...
            try {
                Entrada e = ec.findEntradaS(ent.getEntradaPK(), em);
                ...
                if ((e.getQv()) >= qt) {
                    ...
                    if (!obs.isEnabled()) {
                        ...
                        e.setQs(e.getQs() - qt);
                        s.setObs(null);
                        Tiposaida ts = new TiposaidaJpaController(emf).findTiposaida(2);
                        s.setTiposaida(ts);
                    } else {
                        e.setQd(e.getQd() + qt);
                        s.setObs(obs.getText());
                        Tiposaida ts = new TiposaidaJpaController(emf).findTiposaida(4);
                        s.setTiposaida(ts);
                    }
                    ...
                    lbValidacao.setVisible(true);
                    lbValidacao.setText("Introduza Qtd menor ou igual a Qtd. de venda nesta Serie/Lote");
                    txtQntP.requestFocusInWindow();
                    em.clear();
...
//    }
    ...
    private void cbeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbeItemStateChanged
        ...
        if (e != null) {
            ...
            qtde.setText("Quantidade: " + e.getQv());
        }

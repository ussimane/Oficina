...
import controller.EntradaferJpaController;
 ...
 * @author Ussimane
 */
public class FormAddFer extends javax.swing.JDialog {
    ...
    public FormAddFer(java.awt.Frame parent, Ferramenta e, TableModel tm, int pos, int c, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        EntradaferJpaController ec = new EntradaferJpaController(emf);
        ...
        try {
            ...
            Entradafer ent = new Entradafer(new EntradaferPK(fer.getIdferramenta(), new Date()));
            ent.setQtd(qt);
...
//            tm.setValueAt(fer.getQtd(), pos, 2);
            ...
            em.clear();
            em.getTransaction().commit();
            Logger.getLogger(FormAddFer.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            if (em != null) {
                em.close();
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormAddFer dialog = new FormAddFer(new javax.swing.JFrame(), e,tm, posi, client, true);
